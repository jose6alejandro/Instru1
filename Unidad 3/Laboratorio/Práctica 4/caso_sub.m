...
longitud = length(tt);
errorILmape = mean(abs(((ilData(270:733,2)+5) - (IL_maple_ + 5)) ./ (ilData(270:733,2)+5))) * 100 / longitud;
%figure(3)
...
errorVLmape = mean(abs(((vlData(270:733,2)+5) - (VL_maple_total + 5)) ./ (vlData(270:733,2)+5))) * 100 / longitud;
%figure(3)
